...
echo "**************************************"
#aws s3 sync --acl "public-read" --sse "AES256" public/ s3://$BUCKET_NAME/ --exclude 'assets' --exclude '.DS_Store' --delete
...
#aws s3 sync --cache-control "max-age=-1" --acl "public-read" --sse "AES256"  --delete public/assets/ s3://$BUCKET_NAME/assets/
